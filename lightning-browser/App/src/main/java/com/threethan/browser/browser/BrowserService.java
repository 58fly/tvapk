...
import com.threethan.browser.browser.GeckoView.KioskGeckoSettingsFactory;
...
public class BrowserService extends Service {
    ...
    public BrowserWebView getWebView(BrowserActivity activity) {
        ...
        if (hasWebView(tabId)) {
            ...
            AppDiagnostics.record(this, "WEBVIEW_REUSE", "tab=" + tabId + ", url=" + activity.currentUrl);
            ...
            AppDiagnostics.record(this, "WEBVIEW_CREATE", "tab=" + tabId + ", url=" + activity.currentUrl);
    ...
    private void initRuntime() {
        ...
        BrowserService.sRuntime = GeckoRuntime.create(this, KioskGeckoSettingsFactory.createRuntimeSettings());
        AppDiagnostics.record(this, "GECKO_RUNTIME_CREATE", "runtime initialized");
        // Custom Fixes
    ...
    public void removeActivity(BrowserActivity activity) {
        ...
        AppDiagnostics.record(this, "ACTIVITY_UNREGISTER", "tab=" + activity.tabId);
    }
    ...
    public void killWebView(String tabId) {
        ...
        AppDiagnostics.record(this, "WEBVIEW_KILL", "tab=" + tabId + ", url=" + getUrl(tabId));
        webView.kill();
        webViewByTabId.remove(tabId);
        titleByTabId.remove(tabId);
        urlByTabId.remove(tabId);
        System.gc();
        updateStatus();
    }
